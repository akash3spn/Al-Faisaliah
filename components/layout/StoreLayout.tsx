    ...
    <div className="flex min-h-screen flex-col font-sans">
      <header className="sticky top-0 z-50 w-full bg-black border-b border-primary/20">
        ...
        <div className="container mx-auto flex h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4">
            ...
            <Link to="/" className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <h1 className="text-xl font-bold tracking-widest text-white uppercase m-0 leading-tight">Al-Faisaliah <span className="text-primary">Store</span></h1>
                <p className="text-[10px] text-primary/80 tracking-[0.2em] uppercase m-0 leading-tight">Turaif City, Saudi Arabia</p>
              </div>
            </Link>
          </div>
          ...
          <nav className="hidden lg:flex items-center gap-8 text-xs font-medium uppercase tracking-wider text-muted-foreground">
            ...
            <Link to="/categories/electronics" className="hover:text-primary transition-colors">Electronics</Link>
            <Link to="/categories/toys" className="hover:text-primary transition-colors">Kids Collection</Link>
            <Link to="/offers" className="hover:text-primary transition-colors">Special Offers</Link>
          </nav>
          ...
          <div className="flex items-center gap-4 text-xs font-medium uppercase tracking-wider text-muted-foreground">
            <div className="hidden md:flex bg-[#1a1a1a] px-3 py-2 rounded items-center gap-3 border border-[#333]">
               <span className="text-primary/70">Search...</span>
            ...
            <div className="hidden sm:flex items-center gap-4 border-l border-[#333] pl-4">
               <ModeToggle />
      ...
      <footer className="bg-black border-t border-primary/20 flex flex-col md:flex-row items-center justify-between px-4 sm:px-8 py-6 text-[10px] tracking-widest text-gray-500 uppercase font-medium">
        <div className="flex flex-wrap justify-center gap-4 md:gap-6 mb-4 md:mb-0">
          <span>Free Shipping Over SAR 500</span>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <span className="text-white">© {new Date().getFullYear()} Al-Faisaliah Store</span>
        </div>
      </footer>
    </div>
  )
